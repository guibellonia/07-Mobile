...
export default function ProdutoDetailScreen({ navigation, route }) {
  ...
  const precoFormatado = `R$ ${produto.valor.toFixed(2).replace('.', ',')}`

  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.conteudo}>

      {/* Avatar com ícone de produto */}
      ...
      <View style={styles.card}>
        ...
        <View style={styles.linha}>
          <View style={styles.linhaEsquerda}>
            ...
            <Text style={styles.rotulo}>Valor Unitário</Text>
          </View>
          <Text style={[styles.valor, styles.preco]}>{precoFormatado}</Text>
        </View>
        ...
        <View style={styles.linha}>
          ...
          <Text style={[styles.valor, styles.precoTotal]}>
